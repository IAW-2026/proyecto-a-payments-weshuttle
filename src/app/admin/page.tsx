    ...
    <main className="min-h-screen bg-[#F7F9FB] px-6 py-10 text-[#0A192F]">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-8">
        <section className="rounded-3xl border border-[#D8DADC] bg-white p-8 shadow-sm sm:p-10">
          ...
          <h1 className="mt-3 text-3xl font-bold text-[#0A192F] sm:text-4xl">
        ...
        <section className="grid gap-4 md:grid-cols-2">
          <Link
            ...
            className="rounded-xl border border-[#D8DADC] bg-white p-6 shadow-sm transition hover:border-[#0A192F]"
          >
