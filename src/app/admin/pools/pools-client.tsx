            ...
            {result.credits_generated.length === 0 ? (
              ...
              <div className="divide-y divide-slate-100">
                {result.credits_generated.map((credit) => (
                  <div key={credit.reservation_id} className="p-4 text-xs flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between hover:bg-slate-50/50 transition">
                    <div>
