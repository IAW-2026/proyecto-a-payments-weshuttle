        ...
        <div className="grid gap-8 xl:grid-cols-[0.95fr_1.05fr]">
          <SectionCard>
            <div className="flex items-center justify-between gap-4">
              <div>
                <h3 className="text-xl font-semibold text-primary">Cuenta activa</h3>
                <p className="mt-2 text-sm text-slate-gray">La cuenta donde recibís el dinero de tus viajes.</p>
              </div>
              <Link href="/driver/account" className="text-sm font-semibold text-primary hover:underline">
                Modificar cuenta
              </Link>
            </div>

            <div className="mt-6 rounded-xl border border-outline-custom bg-surface p-5">
              <dl className="grid gap-4 text-sm text-slate-gray sm:grid-cols-2">
                <div>
                  <dt className="font-semibold text-primary">Medio de cobro</dt>
                  <dd className="mt-1">{data.payoutAccount?.provider ?? "Sin configurar"}</dd>
                </div>
                <div>
                  <dt className="font-semibold text-primary">Estado de cuenta</dt>
                  <dd className="mt-1">{data.payoutAccount ? (data.payoutAccount.status === "ACTIVE" ? "Activa" : "Inactiva") : "Pendiente"}</dd>
                </div>
                <div className="sm:col-span-2">
                  <dt className="font-semibold text-primary">CBU, CVU o ID de Mercado Pago</dt>
          ...
          <SectionCard>
            <div className="flex items-center justify-between gap-4">
              ...
              <Link href="/driver/trips?tab=cobros" className="text-sm font-semibold text-primary hover:underline">
