          ...
          <SectionCard>
            ...
            {trips.length === 0 ? (
              ...
              <div className="mt-6 space-y-3">
                {trips.map((trip) => (
                  <article key={trip.id} className="rounded-[24px] border border-slate-200 bg-white p-5 shadow-xs transition hover:border-sky-300">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                      ...
                      <div className="flex items-center justify-between sm:justify-end gap-6">
                        ...
                        <StatusBadge value={trip.status} label={trip.status === "COMPLETED" ? "Cobrado" : "Pendiente"} />
                      </div>
                    </div>
            ...
            {settlementsData.settlements.length === 0 ? (
              ...
              <div className="mt-6 space-y-3">
                {settlementsData.settlements.map((settlement) => (
                  <article key={settlement.id} className="rounded-[24px] border border-slate-200 bg-white p-5 shadow-xs transition hover:border-sky-300">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                      <div className="flex items-center gap-3">
                      ...
                      <div className="flex items-center justify-between sm:justify-end gap-6">
                        ...
                        <StatusBadge value={settlement.status} label={settlement.status === "COMPLETED" ? "Acreditado" : "Pendiente"} />
                      </div>
                    </div>
                    <details className="mt-4 border-t border-slate-100 pt-3 text-xs text-slate-500 cursor-pointer hover:text-slate-800">
                      <summary className="font-medium select-none">Ver detalles técnicos</summary>
